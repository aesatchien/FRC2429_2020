...
class OI(object):
    ...
    def assign_buttons(self):
        ...
        if self.competition_mode:
            ...
            self.co_buttonB.whenPressed(Intake(self.robot, power=-0.6, button=self.co_buttonB))
            self.co_buttonA.whenPressed(Intake(self.robot, power=0.6, button=self.co_buttonA))
